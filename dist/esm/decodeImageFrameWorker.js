...
export async function decodeImageFrame(imageFrame, transferSyntax, pixelData, decodeConfig, options, callbackFn) {
    ...
    switch (transferSyntax) {
        ...
        case '1.2.840.10008.1.2.4.50':
            ...
            decodePromise = decodeJPEGBaseline8Bit(pixelData, opts, decodeConfig?.wasmUrlCodecLibJpegTurbo8bit);
            break;
        ...
        case '1.2.840.10008.1.2.4.80':
            ...
            decodePromise = decodeJPEGLS(pixelData, opts, decodeConfig?.wasmUrlCodecCharls);
            break;
        ...
        case '1.2.840.10008.1.2.4.90':
            ...
            decodePromise = decodeJPEG2000(pixelData, opts, decodeConfig?.wasmUrlCodecOpenJpeg);
            break;
        ...
        case '1.2.840.10008.1.2.4.203':
            ...
            decodePromise = decodeHTJ2K(pixelData, opts, decodeConfig?.wasmUrlCodecOpenJph);
            break;
        default:
